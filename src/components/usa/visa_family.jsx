...
const VisaFamily = () => {
  ...
  return (
    <div className={`${inter.className} bg-gradient-to-br from-[#212020] to-[#2a2a2a] rounded-2xl p-8 w-full max-w-md text-white relative border-2 border-[#22c55e] hover:shadow-2xl hover:-translate-y-2 transition-all duration-300`}>
      {/* Plan Label */}
      <Badge 
        className="absolute -top-3 left-1/2 transform -translate-x-1/2 bg-gradient-to-r from-green-400 to-[#22c55e] text-black px-4 py-1 text-xs font-bold tracking-wide"
      >
        FAMILIAR
      </Badge>
      ...
      {/* Family Badge */}
      <Badge 
        className="absolute -top-2 right-5 bg-green-900 text-white px-3 py-1 text-xs font-semibold"
      >
      ...
      <div className="relative mb-6">
        ...
        <div className="space-y-4">
          <div className="flex items-start gap-3">
            ...
            <span className="font-light text-sm leading-relaxed">Carga del formulario DS-160 para cada miembro</span>
          </div>
